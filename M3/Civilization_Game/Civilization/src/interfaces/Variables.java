...
public interface Variables {
	...
	public final int WOOD_COST_UNITS = {WOOD_COST_SWORDSMAN,WOOD_COST_SPEARMAN,WOOD_COST_CROSSBOW,WOOD_COST_CANNON,WOOD_COST_ARROWTOWER,WOOD_COST_CATAPULT,WOOD_COST _ROCKETLAUNCHERTOWER,WOOD_COST_MAGICIAN,WOOD_COST_PRIEST};
	public final int IRON_COST_UNITS = {IRON_COST_SWORDSMAN,IRON_COST_SPEARMAN,IRON_COST_CROSSBOW,IRON_COST_CANNON,IRON_COST_ARROWTOWER,IRON_COST_CATAPULT,IRON_COST _ROCKETLAUNCHERTOWER,IRON_COST_MAGICIAN,IRON_COST_PRIEST};
	public final int FOOD_COST_UNITS = {FOOD_COST_SWORDSMAN,FOOD_COST_SPEARMAN,FOOD_COST_CROSSBOW,FOOD_COST_CANNON,FOOD_COST_ARROWTOWER,FOOD_COST_CATAPULT,FOOD_COST _ROCKETLAUNCHERTOWER,FOOD_COST_MAGICIAN,FOOD_COST_PRIEST};
	
	//Cost Buildings
    public static final int FOOD_COST_FARM = 5000;
    public static final int WOOD_COST_FARM = 10000;
    public static final int IRON_COST_FARM = 12000;

    public static final int FOOD_COST_CARPENTRY = 5000;
    public static final int WOOD_COST_CARPENTRY = 10000;
    public static final int IRON_COST_CARPENTRY = 12000;

    public static final int FOOD_COST_SMITHY = 5000;
    public static final int WOOD_COST_SMITHY = 10000;
    public static final int IRON_COST_SMITHY = 12000;

    public static final int FOOD_COST_CHURCH = 10000; 
    public static final int WOOD_COST_CHURCH = 20000; 
    public static final int IRON_COST_CHURCH = 24000;
    public static final int MANA_COST_CHURCH = 10000;

    public static final int FOOD_COST_MAGICTOWER = 5000;
    public static final int WOOD_COST_MAGICTOWER = 10000;
    public static final int IRON_COST_MAGICTOWER = 12000;
